...
var games = [730, 1628760, 1044450];  // Enter here AppIDs of the needed games
...
var games2 = [730, 1446850, 1044450];  // Enter here AppIDs of the needed games
...
var games3 = [730, 1446850, 1044450];  // Ingresa aquí los AppIDs de los juegos necesarios
var status3 = 1;  // 1 - en línea, 7 - invisible

user3 = new steamUser();
user3.logOn({"accountName": username3, "password": password3, "twoFactorCode": steamTotp.generateAuthCode(shared_secret3)});
user3.on('loggedOn', () => {
    if (user3.steamID != null) console.log(user3.steamID + ' - Inicio de sesión exitoso');
...
var games4 = [730, 578080, 570];  // Ingresa aquí los AppIDs de los juegos necesarios
var status4 = 1;  // 1 - en línea, 7 - invisible

user4 = new steamUser();
user4.logOn({"accountName": username4, "password": password4, "twoFactorCode": steamTotp.generateAuthCode(shared_secret4)});
user4.on('loggedOn', () => {
    if (user4.steamID != null) console.log(user4.steamID + ' - Inicio de sesión exitoso');
